...
class RatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post rates_url, params: { rate: { comment: @rate.comment, star: @rate.star, tel: @rate.tel } }
    end
  ...
  test "should update rate" do
    patch rate_url(@rate), params: { rate: { comment: @rate.comment, star: @rate.star, tel: @rate.tel } }
